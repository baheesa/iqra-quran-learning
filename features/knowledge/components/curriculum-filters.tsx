...
export function FilterChip(props: {
  ...
  return (
    <button
      ...
      className={
        props.active
          ? "bg-primary text-surface inline-flex shrink-0 items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-xs font-medium sm:text-sm"
...
export function LearnedToggle(props: {
  ...
  return (
    <button
      ...
      className={
        props.learned
          ? "bg-primary text-surface inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full shadow-sm transition-colors"
...
export function NextRemainingButton(props: {
  ...
  return (
    <button
      ...
      className="bg-primary text-surface hover:bg-primary/90 inline-flex h-8 shrink-0 items-center gap-1 rounded-lg px-2 text-xs font-medium shadow-sm transition-colors disabled:cursor-not-allowed disabled:opacity-40"
    >
