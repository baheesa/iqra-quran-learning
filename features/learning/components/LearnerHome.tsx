    ...
    <div className="relative space-y-3 pb-4">
      ...
      <section className="border-primary/20 from-primary/[0.07] overflow-hidden rounded-xl border bg-gradient-to-br to-surface/95">
        <div className="flex">
          ...
          >
            <span className="bg-primary text-surface flex h-8 w-8 shrink-0 items-center justify-center rounded-lg">
          ...
          <Link
            ...
            className={
              "primary" in item && item.primary
                ? "bg-primary text-surface inline-flex min-h-9 items-center gap-1.5 rounded-lg px-2.5 text-xs font-medium"
          ...
          <div className="px-3 pb-3 pt-2">
            ...
            <div className="mx-auto mt-2 flex max-w-sm gap-1.5">
              ...
              <button
                ...
                className="bg-primary text-surface inline-flex min-h-10 flex-1 items-center justify-center rounded-lg"
              >
